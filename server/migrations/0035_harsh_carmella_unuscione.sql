...
ALTER TABLE "orderProduct" ALTER COLUMN "productID" SET DATA TYPE serial;--> statement-breakpoint
ALTER TABLE "productVariants" ALTER COLUMN "productID" SET DATA TYPE serial;--> statement-breakpoint
DO $$ BEGIN
