...
function Head() {
  ...
  return (
    <div className="relative h-screen w-full bg-gradient-to-l dark:from-[#000000] dark:to-[#202020] from-[#ffffff] to-[#dadada] flex lg:items-center items-start overflow-x-hidden overflow-y-clip">
      <motion.div
        style={{ rotate: scale, translateY: "-54%" }}
        className="absolute w-full h-auto origin-center md:top-full lg:-translate-y-full left-[30%] top-[100%] flex items-center justify-center aspect-square"
      >
        <Image
          src={roata}
          alt={"Wheel pzero"}
          width={1000}
          height={1000}
          className="lg:w-4/5 lg:h-4/5 w-full max-w-[400px] lg:max-w-min aspect-square lg:scale-[0.8] scale-[1.7] "
        />
      </motion.div>
      <div className="absolute block lg:hidden w-full h-full dark:bg-[#00000064] bg-[#ffffff9d]"></div>
      <div className="container z-0 pt-[15vh] lg:pt-0">
