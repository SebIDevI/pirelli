  ...
  return (
    <div className="relative h-screen w-full bg-gradient-to-l dark:from-[#000000] dark:to-[#202020] from-[#ffffff] to-[#dadada] flex items-center overflow-x-hidden overflow-y-clip">
      <motion.div
        ...
        className="absolute w-full h-auto origin-center lg:top-full lg:-translate-y-full lg:left-[30%] top-[98%] flex items-center justify-center aspect-square"
      >
        <Image
          src={roata}
          alt={"Wheel pzero"}
          width={1000}
          height={1000}
          className="lg:w-4/5 lg:h-4/5 w-full aspect-square scale-[0.8]"
        />
      </motion.div>
