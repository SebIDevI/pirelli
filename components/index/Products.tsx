    ...
    <div className="pt-8 lcontainer bg-[#f0f0f0] dark:bg-[#0e0e0e] text-secondary-foreground px-6 md:px-12 pb-8">
      ...
      <div className="w-full h-full px-8 md:px-12">
        <Carousel>
          <CarouselContent>
            {prods.map((prod, i) => (
              <CarouselItem className="md:basis-[500px] basis-full" key={i}>
                <div className="flex flex-col bg-secondary max-w-[500px] shadow-lg font-gotham text-center p-6 pb-0 gap-6 h-fit">
