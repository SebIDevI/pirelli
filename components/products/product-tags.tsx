  ...
  return (
    <div className="mb-4 flex gap-4 items-center justify-center">
      <div className="text-secondary">
        <div className="w-full text-secondary-foreground flex items-center gap-4 my-4">
          <div className="w-full flex gap-0">
            <Sheet>
              <div className="h-full">
                <SheetTrigger className="border-2 lg:rounded-l-xl rounded-xl lg:rounded-none bg-yellow-400 border-yellow-400 relative text-black hover:bg-yellow-500 hover:border-yellow-500 px-6 text-base font-gothamBook flex items-center justify-between p-2 gap-3 transition">
                  <p>Toate filtrele</p> <RxMixerHorizontal />
                </SheetTrigger>
                <SheetContent className="lg:w-[600px] max-w-none bg-[#e0e0e0] border-0 text-secondary-foreground px-0 h-auto">
                    ...
                    <ScrollArea className="h-full">
                      <div className="px-6 mt-2">
                        ...
                        <div
                          ...
                          aria-disabled
                        >
                          Promotii (0) <Checkbox className="w-6 h-6" disabled />
                        </div>
                      </div>
            ...
            <div className="lg:flex hidden w-[710px]">
              {filtersLocal.map((filter, i) => (
                <button
                  key={i}
                  className={`bg-white relative text-black hover:bg-gray-100 hover:border-white/40 px-6 text-base font-gothamBook flex items-center justify-between p-2 gap-2 transition`}
                >
        ...
        <Separator className="my-10 bg-gray-400/30" />
      </div>
    </div>
  );
}
