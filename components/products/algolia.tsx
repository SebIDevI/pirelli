...
function Hit({
  ...
  return (
    <div className="p-4 mb-2 hover:bg-secondary rounded-md">
      <Link
        href={`/products/${hit.title}?id=${hit.objectID}&productID=${hit.id}&price=${hit.price}&title=${hit.title}&type=${hit.productType}&image=${hit.variantImages[0]}&variantID=${hit.objectID}`}
      >
