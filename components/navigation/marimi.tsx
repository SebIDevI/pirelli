...
function Marimi() {
  ...
  return (
    <Sheet>
      <SheetTrigger className="w-full py-3 px-6 hover:bg-gray-300/40 md830:hover:bg-transparent text-start transition">
        Ghid mărimi
      </SheetTrigger>
      <SheetContent
        overlay={false}
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-lg py-4">
            Toate anvelopele au numere diferite pe flanc corespunzătoare pentru:
            lățimea secțiunii, înălțime, cod de construcție și diamentrul jantă,
            indice încărcare și de viteză.
          </p>
              ...
              >
                ...
                <path
                  className={`transition-all duration-500 ${
                    currSize === "size1" ? "fill-[#FD0]" : "fill-secondary"
                  }`}
                ...
                <path
                  className={`transition-all duration-500 ${
                    currSize === "size2" ? "fill-[#FD0]" : "fill-secondary"
                  }`}
                ...
                <path
                  className={`transition-all duration-500 ${
                    currSize === "size3" ? "fill-[#FD0]" : "fill-secondary"
                  }`}
                ...
                <path
                  ...
                  className={`transition-all duration-500 ${
                    currSize === "size4" ? "fill-[#FD0]" : "fill-secondary"
                  }`}
                ></path>
                <path
              ...
              <AnimatePresence>
                {currSize === "size3" && (
                  <motion.p
                    ...
                    className="absolute -bottom-4 translate-y-full opacity-0 font-gotham text-center text-lg"
                  >
                    Numărul din două cifre vă arată diametrul jantelor pe care
                    cauciucul trebuie montat, în inci.
                  </motion.p>
                )}
              </AnimatePresence>
              <AnimatePresence>
